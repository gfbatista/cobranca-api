...
import com.dev.cobranca.api.exceptionhandler.CobrancaExceptionHandler.Erro;
import com.dev.cobranca.api.model.Lancamento;
import com.dev.cobranca.api.repository.filter.LancamentoFilter;
import com.dev.cobranca.api.service.LancamentoService;
...
public class LancamentoResource {
	...
	public List<Lancamento> pesquisar(LancamentoFilter lancamentoFilter) {
		return lancamentoService.listar(lancamentoFilter);
	}
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		Lancamento lancamento = lancamentoService.buscarCodigo(codigo);
